<template>
  <div>
      <!-- 面包屑导航区域 -->
    <Breadcrumb :firstmenu="'商品管理'" :secmenu="'商品分类'"></Breadcrumb>
    <el-card>
      <!--button按钮-->
      <el-row>
        <el-col>
      ...
      <zk-table ref="table" :data="cateList" :columns="columns" :expand-type="false" :selection-type="false" show-index index-text="#">
    ...
    <!--添加分类的对话框-->
    <el-dialog title="添加分类" :visible.sync="addCateDialogVisible" width="50%" @close="cateDialogClosed">
      <!--表单内容组件-->
      <el-form :model="addCateForm" :rules="addCateRules" ref="addCateRef" label-width="100px">
        ...
        <el-form-item label="父级名称: ">
          ...
          -->
          <el-cascader v-model="selectedcKeys" :options="options" :props="CascaderProps" @change="handleChange" clearable></el-cascader>
        </el-form-item>
      </el-form>
